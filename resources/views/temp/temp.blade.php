    ...
    <div class="container-scroller">
        ...
        <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
            <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
                <a class="navbar-brand brand-logo mr-5" href="{{ url('/dashboard') }}">
                    <img src="{{ asset('uploads/logoo (5).png') }}" class="mr-2" alt="logo" />
                </a>
                <a class="navbar-brand brand-logo-mini" href="{{ url('/dashboard') }}">
                    <img src="{{ asset('\uploads/logoo (5).png') }}" alt="logo" />
                </a>
            </div>
            <div class="navbar-menu-wrapper d-flex align-items-center justify-content-end">
                ...
                <ul class="navbar-nav navbar-nav-right">
                    <li class="nav-item nav-profile dropdown">
                        <a class="icon-ellipsis" href="#" data-toggle="dropdown" id="profileDropdown">
                        </a>
                        <div class="dropdown-menu dropdown-menu-right navbar-dropdown"
                            ...
                            <button type="button" class="btn btn-link dropdown-item" data-toggle="modal"
                                data-target="#dendaModal">
                                <i class="ti-settings text-primary"></i>Denda
                            </button>
                        </div>
                    </li>
                </ul>
        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <div class="main-panel">
                ...
                @isset($denda)
                    @foreach ($denda as $d)
                        <div class="modal fade" id="dendaModal{{ $d->denda }}" tabindex="-1" aria-labelledby="dendaModalLabel"
                            aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form class="forms-sample" action="{{ url('/denda/update', $d->id_denda) }}"
                                            method="post">
                                            @csrf

                                            <div class="form-group">
                                                <label>Denda</label>
                                                <input type="number" class="form-control" name="denda" value="{{ $d->denda }}">
                                            </div>
